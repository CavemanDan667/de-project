...
def test_function_correctly_populates_table(conn):
    ...
    assert payment_result[0:3] == [[1, 1, datetime.date(2020, 1, 1), datetime.time(10, 0), datetime.date(2020, 10, 10), datetime.time(11, 30), 1, 1, Decimal('123.45'), 1, 1, False, datetime.date(2023, 10, 10)], [2, 2, datetime.date(2020, 1, 1), datetime.time(10, 0), datetime.date(2020, 10, 10), datetime.time(11, 30), 2, 2, Decimal('3333.55'), 2, 3, True, datetime.date(2023, 10, 10)], [3, 3, datetime.date(2020, 1, 1), datetime.time(10, 0), datetime.date(2020, 10, 10), datetime.time(11, 30), 3, 3, Decimal('60500.99'), 3, 1, False, datetime.date(2023, 10, 10)]]
